...
module.exports = function (e) {
  ...
  var button = '<a class="btn right" href="javascript:window.location.reload()">重试</a>'
  ...
  if (typeof e === 'object') {
    ...
    switch (e.errorCode) {
      case -106:
        title = '没有Internet连接'
        info = `<p>计算机没有连接到互联网.</p><p>尝试:</p><ul><li>重置 Wi-Fi 连接<li>检查您的路由.</li></ul>`
        break
      case -105:
        icon = 'fa-frown-o'
        info = `<p>无法解析DNS: <strong>${origin}</strong></p>`
        break
      case 404:
        icon = 'fa-frown-o'
        title = e.title || '页面未找到'
      ...
      case -501:
        title = '您的连接不安全'
        info = `<p>浏览器无法建立一个安全连接到 <strong>${origin}</strong>.</p>`
        icon = 'fa-close warning'
        button = '<a class="btn right" href="javascript:window.history.back()">返回</a>'
        break
      case 504:
        icon = 'fa-share-alt'
